...
for train_iteration in range(1500):
	...
	df=pd.read_csv("C:/Users/IYI/Desktop/matlab_yedek/aaa_mineral/minerals/birlestirilmis_3000/FinalData_3000.csv")
	(a,b)=np.shape(df)
	#print(a,b)
	data = df.values[:,0:b-1]
	label = df.values[:,b-1]
...
with open("C:/Users/IYI/Desktop/matlab_yedek/aaa_mineral/minerals/birlestirilmis_3000/FinalData_3001.csv","a") as f:
